...
- ✅ [PRO Version Available](https://appseed.us/product/volt-dashboard-pro/django/) - `enhanced UI` and more `features` 
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c0421baa-f390-4033-a4d7-c8d4f3f4573f.git
$ cd c0421baa-f390-4033-a4d7-c8d4f3f4573f
```
